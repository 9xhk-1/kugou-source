...
public final class SubjectSubscriptionManager<T> extends AtomicReference<State<T>> implements Observable.OnSubscribe<T> {
    ...
    public static final class SubjectObserver<T> implements Observer<T> {
        ...
        public void emitFirst(Object obj) throws Throwable {
            synchronized (this) {
        ...
        */
        public void emitLoop(java.util.List<java.lang.Object> r5, java.lang.Object r6) throws java.lang.Throwable {
            /*
                r4 = this;
                r0 = 1
                r1 = 1
