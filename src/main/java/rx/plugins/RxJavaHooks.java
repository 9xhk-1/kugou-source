...
public final class RxJavaHooks {
    ...
    public static volatile Func1<Completable.Operator, Completable.Operator> onCompletableLift;
    public static volatile Func2<Completable, Completable.OnSubscribe, Completable.OnSubscribe> onCompletableStart;
    public static volatile Func1<Throwable, Throwable> onCompletableSubscribeError;
    ...
    public static volatile Func1<Scheduler, Scheduler> onNewThreadScheduler;
    ...
    public static volatile Func1<Observable.Operator, Observable.Operator> onSingleLift;
