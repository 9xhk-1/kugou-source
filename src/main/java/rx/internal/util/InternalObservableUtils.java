...
public enum InternalObservableUtils {
    ...
    public static final class ReplaySupplierBuffer<T> implements Func0<ConnectableObservable<T>> {
        ...
        public ReplaySupplierBuffer(Observable<T> observable, int i2) {
    ...
    public static final class ReplaySupplierTime<T> implements Func0<ConnectableObservable<T>> {
        ...
        public ReplaySupplierTime(Observable<T> observable, int i2, long j, TimeUnit timeUnit, Scheduler scheduler) {
            this.time = j;
            this.unit = timeUnit;
            this.scheduler = scheduler;
            this.bufferSize = i2;
    ...
    public static <T> Func0<ConnectableObservable<T>> createReplaySupplier(Observable<T> observable, int i2, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return new ReplaySupplierTime(observable, i2, j, timeUnit, scheduler);
    }
}
