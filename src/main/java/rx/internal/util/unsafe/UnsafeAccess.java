...
public final class UnsafeAccess {
    ...
    public static boolean compareAndSwapInt(Object obj, long j, int i2, int i3) {
        return UNSAFE.compareAndSwapInt(obj, j, i2, i3);
    }

    public static int getAndAddInt(Object obj, long j, int i2) {
        Unsafe unsafe;
        int intVolatile;
        do {
            unsafe = UNSAFE;
            intVolatile = unsafe.getIntVolatile(obj, j);
        } while (!unsafe.compareAndSwapInt(obj, j, intVolatile, intVolatile + i2));
        return intVolatile;
    }
    ...
    public static int getAndSetInt(Object obj, long j, int i2) {
        Unsafe unsafe;
        int intVolatile;
        do {
            unsafe = UNSAFE;
            intVolatile = unsafe.getIntVolatile(obj, j);
        } while (!unsafe.compareAndSwapInt(obj, j, intVolatile, i2));
        return intVolatile;
    }
