...
public class AssertableSubscriberObservable<T> extends Subscriber<T> implements AssertableSubscriber<T> {
    ...
    public final AssertableSubscriber<T> assertFailureAndMessage(Class<? extends Throwable> cls, String str, T... tArr) {
        ...
        throw new AssertionError("Error message differs. Expected: '" + str + "', Received: '" + message + LyricManager.STR_REPLACE_RESULT_TAG);
    }
    ...
    @Override // rx.observers.AssertableSubscriber
    public AssertableSubscriber<T> assertValueCount(int i2) {
    ...
    @Override // rx.observers.AssertableSubscriber
    public final AssertableSubscriber<T> awaitValueCount(int i2, long j, TimeUnit timeUnit) {
        if (this.ts.awaitValueCount(i2, j, timeUnit)) {
            return this;
        }
