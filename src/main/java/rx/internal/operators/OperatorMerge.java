...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    public static final class HolderDelayErrors {
        public static final OperatorMerge<Object> INSTANCE = new OperatorMerge<>(true, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }

    public static final class HolderNoDelay {
        public static final OperatorMerge<Object> INSTANCE = new OperatorMerge<>(false, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
