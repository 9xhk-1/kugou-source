...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    public final AtomicReference<Subject<? super T, ? extends R>> connectedSubject;
    public final Object guard;
    public Subscription guardedSubscription;
    public final Observable<? extends T> source;
    public final Func0<? extends Subject<? super T, ? extends R>> subjectFactory;
    public Subscriber<T> subscription;
    public final List<Subscriber<? super R>> waitingForConnect;
