...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
    ...
    public static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public SizeAndTimeBoundReplayBuffer(int i2, long j, Scheduler scheduler) {
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> observable, final int i2) {
        return i2 == Integer.MAX_VALUE ? create(observable) : create(observable, new Func0<ReplayBuffer<T>>() { // from class: rx.internal.operators.OperatorReplay.5
            @Override // rx.functions.Func0, java.util.concurrent.Callable
    ...
    public static <T> ConnectableObservable<T> create(Observable<? extends T> observable, long j, TimeUnit timeUnit, final Scheduler scheduler, final int i2) {
