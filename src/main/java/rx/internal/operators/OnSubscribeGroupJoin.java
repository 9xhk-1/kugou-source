        ...
        public final class LeftObserver extends Subscriber<T1> {
            ...
            public void onNext(T1 t1) {
                ...
                try {
                    ...
                    LeftDurationObserver leftDurationObserver = ResultManager.this.new LeftDurationObserver(i2);
        ...
        public final class RightObserver extends Subscriber<T2> {
            ...
            public void onNext(T2 t2) {
                ...
                try {
                    ...
                    RightDurationObserver rightDurationObserver = ResultManager.this.new RightDurationObserver(i2);
