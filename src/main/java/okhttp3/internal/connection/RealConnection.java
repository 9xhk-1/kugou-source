...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private Request createTunnel(int i2, int i3, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            if ("close".equalsIgnoreCase(responseBuild.header(HTTP.CONN_DIRECTIVE))) {
    ...
    private Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header(HTTP.TARGET_HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", HTTP.CONN_KEEP_ALIVE).header(HTTP.USER_AGENT, Version.userAgent()).build();
    ...
    */
    public void connect(int r17, int r18, int r19, int r20, int r21, boolean r22, okhttp3.Call r23, okhttp3.EventListener r24) throws java.lang.Throwable {
        /*
