...
public final class StreamAllocation {
    ...
    */
    ...
    private RealConnection findConnection(int i2, int i3, int i4, int i5, int i6, boolean z) throws Throwable {
        ...
        realConnection2.connect(i2, i3, i4, i5, i6, z, this.call, this.eventListener);
    ...
    private RealConnection findHealthyConnection(int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2) throws Throwable {
        while (true) {
            RealConnection realConnectionFindConnection = findConnection(i2, i3, i4, i5, i6, z);
            synchronized (this.connectionPool) {
    ...
    public HttpCodec newStream(OkHttpClient okHttpClient, Interceptor.Chain chain, boolean z) {
        try {
            HttpCodec httpCodecNewCodec = findHealthyConnection(chain.connectTimeoutMillis(), chain.connectIpv6TimeoutMillis(), chain.readTimeoutMillis(), chain.writeTimeoutMillis(), okHttpClient.pingIntervalMillis(), okHttpClient.retryOnConnectionFailure(), z).newCodec(okHttpClient, chain, this);
            synchronized (this.connectionPool) {
