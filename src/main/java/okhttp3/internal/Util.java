...
public final class Util {
    ...
    public static String canonicalizeHost(String str) {
        ...
        throw new AssertionError("Invalid IPv6 address: '" + str + LyricManager.STR_REPLACE_RESULT_TAG);
    }
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i3) {
                ...
                buffer.writeHexadecimalUnsignedLong(((bArr[i2] & ExifInterface.MARKER) << 8) | (bArr[i2 + 1] & ExifInterface.MARKER));
                i2 += 2;
            }
        }
