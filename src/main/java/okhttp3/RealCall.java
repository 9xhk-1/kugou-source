...
public final class RealCall implements Call {
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        e2 = e3;
                        IOException iOExceptionTimeoutExit = RealCall.this.timeoutExit(e2);
                        if (z) {
    ...
    public Response execute() throws IOException {
        ...
        try {
            try {
                ...
                IOException iOExceptionTimeoutExit = timeoutExit(e2);
    ...
    public Response getResponseWithInterceptorChain() throws IOException {
        ...
        return new RealInterceptorChain(arrayList, null, null, null, 0, this.originalRequest, this, this.eventListener, this.client.connectTimeoutMillis(), this.client.connectIpv6TimeoutMillis(), this.client.readTimeoutMillis(), this.client.writeTimeoutMillis()).proceed(this.originalRequest);
    }
