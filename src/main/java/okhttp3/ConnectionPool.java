...
public final class ConnectionPool {
    ...
    public static final Executor executor = new ThreadPoolExecutor(0, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkHttp ConnectionPool", true));
    ...
    public long cleanup(long j) {
        synchronized (this) {
            ...
            if (j2 < j4 && i2 <= this.maxIdleConnections) {
                if (i2 > 0) {
                    return j4 - j2;
                }
                if (i3 > 0) {
