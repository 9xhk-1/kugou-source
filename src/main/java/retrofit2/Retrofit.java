...
public class Retrofit {
    public static String httpVarsClassName;
    ...
    public final boolean isEnableSSA;
    public final String jsonScheme;
    public final boolean proxyEnable;
    private final Map<Method, ServiceMethod<?>> serviceMethodCache = new ConcurrentHashMap();
    public final boolean validateEagerly;

    public Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, List<CallAdapter.Factory> list2, Executor executor, boolean z, boolean z2, String str, boolean z3) {
    ...
    public static void initHttpVarsClassName(String str) {
        httpVarsClassName = str;
    }
    ...
    public static final class Builder {
        ...
        public Retrofit build() {
            ...
            httpUrl.setModuleName(this.moduleName);
            Call.Factory oKHttpClient = this.callFactory;
            if (oKHttpClient == null) {
                oKHttpClient = RetrofitClientManager.getOKHttpClient(this.baseUrl);
            }
            ...
            return new Retrofit(factory, this.baseUrl, Collections.unmodifiableList(arrayList2), Collections.unmodifiableList(arrayList), executor, this.validateEagerly, this.proxyEnable, this.jsonScheme, this.isEnableSSA);
        }
        ...
        public Builder jsonSchemeUrl(String str) {
            this.jsonScheme = str;
            return this;
        }
        ...
        public Builder setEnableSSA(boolean z) {
            this.isEnableSSA = z;
            return this;
        }

        public Builder setExcludeEndChar() {
            HttpUrl httpUrl = this.baseUrl;
            if (httpUrl == null) {
        ...
        public Builder setMultiUrl(@NonNull String[] strArr) {
            Objects.requireNonNull(strArr, "urls should not be null");
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (!strArr[i2].endsWith("/")) {
                    strArr[i2] = strArr[i2].concat("/");
                }
                if (i2 == 0 && strArr[0].length() > 0) {
                    jsonSchemeUrl(strArr[0]);
                }
            }
            return baseUrl(HttpUrl.get(strArr));
        }
        ...
        public Builder(Retrofit retrofit) {
            ...
            this.proxyEnable = retrofit.proxyEnable;
            this.jsonScheme = retrofit.jsonScheme;
            this.isEnableSSA = retrofit.isEnableSSA;
        }
    }
}
