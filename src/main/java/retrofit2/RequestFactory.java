...
public final class RequestFactory {
    ...
    private final boolean isEnableSSA;
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        return requestBuilder.get().tag(Invocation.class, new Invocation(this.method, arrayList)).proxyEnable(this.proxyEnable).setJsonScheme(this.jsonScheme).setSupportSSA(this.isEnableSSA).build();
    }
}
