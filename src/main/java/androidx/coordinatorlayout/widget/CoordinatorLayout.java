    ...
    */
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i6) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    if (i5 > 0) {
                        iMin = Math.max(i7, this.mBehaviorConsumed[1]);
                    } else {
                        iMin = Math.min(i7, this.mBehaviorConsumed[1]);
                    }
                    i7 = iMin;
                    z = true;
                }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            if (zHasValue) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, typedArrayObtainStyledAttributes.getString(i2));
            }
            typedArrayObtainStyledAttributes.recycle();
            Behavior behavior = this.mBehavior;
            if (behavior != null) {
