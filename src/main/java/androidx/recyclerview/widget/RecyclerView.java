...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
  ...
  0x0181: PHI (r1v12 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
  ...
  0x0181: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x0102] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void fling(int i2, int i3) {
            ...
            this.mOverScroller.fling(0, 0, i2, i3, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Integer.MIN_VALUE, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
            postOnAnimation();
        }
    ...
    public View focusSearch(View view, int i2) {
        ...
        if (z2 && (i2 == 2 || i2 == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i3 = i2 == 2 ? FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS : 33;
