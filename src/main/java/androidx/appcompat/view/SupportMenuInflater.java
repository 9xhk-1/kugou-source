    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i2)) {
                this.itemCheckable = tintTypedArrayObtainStyledAttributes.getBoolean(i2, false) ? 1 : 0;
            } else {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i3)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i3, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i4 = R.styleable.MenuItem_iconTint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i4)) {
                this.itemIconTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(i4);
            } else {
