...
public class ThemeUtils {
    ...
    public static final int[] DISABLED_STATE_SET = {SkinDelegate.STATE_ENABLED};
    ...
    public static final int[] NOT_PRESSED_OR_FOCUSED_STATE_SET = {SkinDelegate.STATE_PRESSED, -16842908};
