...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z || i8 + i7 > i5)) {
            i5--;
        }
        int i10 = i5 - i7;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            iMeasureChildForCells = i6 / i11;
            i2 = i11 + ((i6 % i11) / iMeasureChildForCells);
        } else {
            i2 = 0;
        ...
        while (i12 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z3 = (i10 > 0 || z2) && i6 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z4 = z3;
                i3 = size;
                if (z3) {
                    ...
                    z3 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? i6 + i13 <= 0 : i6 < 0);
                }
                if (z3 && groupId2 != 0) {
