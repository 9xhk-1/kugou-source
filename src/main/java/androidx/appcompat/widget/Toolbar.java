    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, iMax4 + i6, i3, i5, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax2 = Math.max(iMax2, measureChildCollapseMargins(this.mSubtitleTextView, i2, iMax4 + i6, i3, measuredHeight + i5, iArr));
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context2, attributeSet, iArr, i2, 0);
        ...
        dimensionPixelOffset = tintTypedArrayObtainStyledAttributes.hasValue(i3) ? tintTypedArrayObtainStyledAttributes.getDimensionPixelOffset(i3, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        if (tintTypedArrayObtainStyledAttributes.hasValue(i4)) {
            setTitleTextColor(tintTypedArrayObtainStyledAttributes.getColorStateList(i4));
        }
        int i5 = R.styleable.Toolbar_subtitleTextColor;
        if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
            setSubtitleTextColor(tintTypedArrayObtainStyledAttributes.getColorStateList(i5));
        }
        int i6 = R.styleable.Toolbar_menu;
        if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
            inflateMenu(tintTypedArrayObtainStyledAttributes.getResourceId(i6, 0));
        }
