...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (MATCH_ID_STR.equalsIgnoreCase(strTrim)) {
                ...
                if (!strTrim.isEmpty()) {
                    throw new InflateException("Unknown match type in matchOrder: '" + strTrim + LyricManager.STR_REPLACE_RESULT_TAG);
                }
    ...
    */
    ...
    public void pause(View view) {
        ...
        for (int i2 = size - 1; i2 >= 0; i2--) {
            AnimationInfo animationInfoValueAt = runningAnimators.valueAt(i2);
    ...
    public String toString(String str) {
        String str2 = str + getClass().getSimpleName() + TopicHighlightHelper.AT + Integer.toHexString(hashCode()) + ": ";
        if (this.mDuration != -1) {
