    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        for (int i10 = 0; i10 < this.mWidgetsCount; i10++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                constraintAnchorArr3[i11].mSolverVariable = solverVariableCreateObjectVariable;
                ...
                if (i11 == 0 || i11 == 2) {
                    linearSystem.addLowerBarrier(constraintAnchor.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin - i12, z2);
                } else {
                    linearSystem.addGreaterBarrier(constraintAnchor.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i12, z2);
                }
                linearSystem.addEquality(constraintAnchor.mSolverVariable, solverVariableCreateObjectVariable, this.mMargin + i12, i9);
            }
        }
