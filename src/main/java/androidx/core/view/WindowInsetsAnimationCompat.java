...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl {
        ...
        public Impl(int i2, @Nullable Interpolator interpolator, long j) {
            this.mTypeMask = i2;
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f2, int i2) {
            ...
            for (int i3 = 1; i3 <= 256; i3 <<= 1) {
                if ((i2 & i3) == 0) {
                    ...
                    Double.isNaN(d5);
                    builder.setInsets(i3, WindowInsetsCompat.insetInsets(insets, i4, (int) (d3 + 0.5d), i5, (int) (d5 + 0.5d)));
                }
            }
    ...
    public WindowInsetsAnimationCompat(int i2, @Nullable Interpolator interpolator, long j) {
        ...
        if (i3 >= 30) {
            this.mImpl = new Impl30(i2, interpolator, j);
        } else if (i3 >= 21) {
            this.mImpl = new Impl21(i2, interpolator, j);
        } else {
    ...
    public static class Impl30 extends Impl {
        ...
        public Impl30(int i2, Interpolator interpolator, long j) {
