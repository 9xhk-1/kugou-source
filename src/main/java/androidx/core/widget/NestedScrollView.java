...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    private boolean scrollAndFocus(int i2, int i3, int i4) {
        ...
        boolean z = false;
        boolean z2 = i2 == 33;
        View viewFindFocusableViewInBounds = findFocusableViewInBounds(z2, i3, i4);
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        int i2 = FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            return !keyEvent.isAltPressed() ? arrowScroll(FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS) : fullScroll(FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i3) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(FrameLayout.getChildMeasureSpec(i2, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, BasicMeasure.EXACTLY));
            }
        }
    }
    ...
    public boolean onRequestFocusInDescendants(int i2, Rect rect) {
        if (i2 == 2) {
            i2 = FileManagerErrorCode.ENGINE_TARGET_ALREADY_EXISTS;
        } else if (i2 == 1) {
            i2 = 33;
        }
