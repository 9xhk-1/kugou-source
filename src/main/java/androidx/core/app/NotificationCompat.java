...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public RemoteViews createBigContentView() {
            ...
            return i2 >= 24 ? Notification.Builder.recoverBuilder(this.mContext, notificationBuild).createBigContentView() : notificationBuild.bigContentView;
        }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            Notification notificationBuild = notificationCompatBuilder.build();
            return i2 >= 24 ? Notification.Builder.recoverBuilder(this.mContext, notificationBuild).createHeadsUpContentView() : notificationBuild.headsUpContentView;
        }
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z = i4 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES);
        boolean z2 = action.getExtras().getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true);
        int semanticAction = i4 >= 28 ? action.getSemanticAction() : action.getExtras().getInt(Action.EXTRA_SEMANTIC_ACTION, 0);
        ...
        return new Action(i2, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, semanticAction, z2, zIsContextual);
    }
    ...
    public static List<Action> getInvisibleActions(@NonNull Notification notification) {
        ...
        Bundle bundle2;
        ArrayList arrayList = new ArrayList();
        if (Build.VERSION.SDK_INT >= 19 && (bundle = notification.extras.getBundle(CarExtender.EXTRA_CAR_EXTENDER)) != null && (bundle2 = bundle.getBundle(CarExtender.EXTRA_INVISIBLE_ACTIONS)) != null) {
