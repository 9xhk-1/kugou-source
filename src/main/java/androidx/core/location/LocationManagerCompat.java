...
public final class LocationManagerCompat {
    ...
    public static boolean isLocationEnabled(@NonNull LocationManager locationManager) {
        ...
        if (i2 <= 19) {
            try {
                ...
                return i2 == 19 ? Settings.Secure.getInt(((Context) sContextField.get(locationManager)).getContentResolver(), "location_mode", 0) != 0 : !TextUtils.isEmpty(Settings.Secure.getString(r4.getContentResolver(), "location_providers_allowed"));
    ...
    @androidx.annotation.RequiresPermission(com.kugou.common.permission.Permission.ACCESS_FINE_LOCATION)
    /*
