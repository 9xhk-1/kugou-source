...
public class FontProvider {
    ...
    public static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            String[] strArr = {DbOpenHelper.ID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                int columnIndex2 = cursorQuery.getColumnIndex(DbOpenHelper.ID);
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i4, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : HttpStatus.SC_BAD_REQUEST, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i2));
                }
