    ...
    */
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z, boolean z2) {
            ...
            Double.isNaN(d11);
            double d27 = d3 * d11;
            arcToBezier(path, (d26 * dCos) - (d27 * dSin), (d26 * dSin) + (d27 * dCos), d7, d11, d4, d6, radians, dAtan2, dAtan22);
        }
        ...
        public static void nodesToPath(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            char c = 'm';
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                addCommand(path, fArr, c, pathDataNodeArr[i2].mType, pathDataNodeArr[i2].mParams);
