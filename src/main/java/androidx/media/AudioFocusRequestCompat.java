...
public class AudioFocusRequestCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static AudioFocusRequest createInstance(int i2, AudioAttributes audioAttributes, boolean z, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler) {
    ...
    public AudioFocusRequestCompat(int i2, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z) {
        ...
        if (i3 >= 26) {
            this.mFrameworkAudioFocusRequest = Api26Impl.createInstance(i2, getAudioAttributes(), z, this.mOnAudioFocusChangeListener, handler);
        } else {
