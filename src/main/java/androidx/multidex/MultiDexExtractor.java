    ...
    private List<ExtractedDex> loadExistingExtractions(Context context, String str) throws IOException {
        ...
        while (i3 <= i2) {
            ...
            if (!extractedDex.isFile()) {
                throw new IOException("Missing extracted secondary dex file '" + extractedDex.getPath() + LyricManager.STR_REPLACE_RESULT_TAG);
            }
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i3 < 3 && !z2) {
                    ...
                    sb.append(z ? "succeeded" : CommNetSongUrlInfo.ERRSTR_FAILED);
                    sb.append(" '");
                    ...
                    if (!z) {
                        ...
                        if (extractedDex.exists()) {
                            Log.w("MultiDex", "Failed to delete corrupted secondary dex '" + extractedDex.getPath() + LyricManager.STR_REPLACE_RESULT_TAG);
                        }
                    }
                    z2 = z;
                    i3 = i4;
