...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        if (i3 == 8388691 || i3 == 8388693) {
            this.badgeCenterY = rect.bottom - i2;
        } else {
            this.badgeCenterY = rect.top + i2;
        }
        if (getNumber() <= 9) {
        ...
        if (i5 == 8388659 || i5 == 8388691) {
            this.badgeCenterX = ViewCompat.getLayoutDirection(view) == 0 ? (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i4 : ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i4;
        } else {
            this.badgeCenterX = ViewCompat.getLayoutDirection(view) == 0 ? ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - i4 : (rect.left - this.halfBadgeWidth) + dimensionPixelSize + i4;
        }
    }
