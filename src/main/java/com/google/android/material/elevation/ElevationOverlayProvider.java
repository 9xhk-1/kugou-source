...
public class ElevationOverlayProvider {
    ...
    public float calculateOverlayAlphaFraction(float f2) {
        ...
        return Math.min(((((float) Math.log1p(f2 / r0)) * 4.5f) + FORMULA_OFFSET) / 100.0f, 1.0f);
    }
    ...
    public int compositeOverlay(@ColorInt int i2, float f2) {
        ...
        return ColorUtils.setAlphaComponent(MaterialColors.layer(ColorUtils.setAlphaComponent(i2, 255), this.elevationOverlayColor, fCalculateOverlayAlphaFraction), Color.alpha(i2));
    }
