    ...
    private void updateIconPosition(int i2, int i3) {
        ...
        if (!isIconStart() && !isIconEnd()) {
            if (isIconTop()) {
                ...
                int textHeight = (((((i3 - getTextHeight()) - getPaddingTop()) - intrinsicHeight) - this.iconPadding) - getPaddingBottom()) / 2;
        ...
        int textWidth = (((((i2 - getTextWidth()) - ViewCompat.getPaddingEnd(this)) - intrinsicWidth) - this.iconPadding) - ViewCompat.getPaddingStart(this)) / 2;
