...
public class TransitionUtils {
    ...
    public static boolean maybeApplyThemeDuration(Transition transition, Context context, @AttrRes int i2) {
        int iResolveInteger;
        if (i2 == 0 || transition.getDuration() != -1 || (iResolveInteger = MaterialAttributes.resolveInteger(context, i2, -1)) == -1) {
            return false;
        }
    ...
    public static boolean maybeApplyThemeInterpolator(Transition transition, Context context, @AttrRes int i2, TimeInterpolator timeInterpolator) {
        ...
        transition.setInterpolator(resolveThemeInterpolator(context, i2, timeInterpolator));
        return true;
    }
    ...
    public static TimeInterpolator resolveThemeInterpolator(Context context, @AttrRes int i2, @NonNull TimeInterpolator timeInterpolator) {
