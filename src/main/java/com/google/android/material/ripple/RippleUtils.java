...
public class RippleUtils {
    ...
    static {
        ...
        SELECTED_HOVERED_FOCUSED_STATE_SET = new int[]{16842913, R.attr.state_hovered, R.attr.state_focused};
        SELECTED_FOCUSED_STATE_SET = new int[]{16842913, R.attr.state_focused};
        SELECTED_HOVERED_STATE_SET = new int[]{16842913, R.attr.state_hovered};
