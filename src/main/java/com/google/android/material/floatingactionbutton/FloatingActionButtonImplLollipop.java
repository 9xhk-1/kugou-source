...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private Animator createElevationAnimator(float f2, float f3) {
        ...
        animatorSet.play(ObjectAnimator.ofFloat(this.view, Key.ELEVATION, f2).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, f3).setDuration(100L));
