...
public class FloatingActionButtonImpl {
    ...
    public static final int[] HOVERED_FOCUSED_ENABLED_STATE_SET = {R.attr.state_hovered, R.attr.state_focused, 16842910};
    public static final int[] FOCUSED_ENABLED_STATE_SET = {R.attr.state_focused, 16842910};
    public static final int[] HOVERED_ENABLED_STATE_SET = {R.attr.state_hovered, 16842910};
