    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i2, float f2, int i3) {
            ...
            if (tabLayout != null) {
                ...
                tabLayout.setScrollPosition(i2, f2, i4 != 2 || this.previousScrollState == 1, (i4 == 2 && this.previousScrollState == 0) ? false : true);
            }
        }
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    layerDrawable = new RippleDrawable(colorStateListConvertToRippleDrawableColor, gradientDrawable3, z ? null : gradientDrawable2);
                } else {
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i5)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i5);
            }
            int i6 = R.styleable.TabLayout_tabSelectedTextColor;
            if (typedArrayObtainStyledAttributes.hasValue(i6)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(i6, 0));
            }
