...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    public static ChipDrawable createFromResource(@NonNull Context context, @XmlRes int i2) {
        ...
        return createFromAttributes(context, drawableXml, R.attr.chipStandaloneStyle, styleAttribute);
    }
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Chip, i2, i3, new int[0]);
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i4)) {
            setChipCornerRadius(typedArrayObtainStyledAttributes.getDimension(i4, 0.0f));
        }
        ...
        textAppearance.textSize = typedArrayObtainStyledAttributes.getDimension(R.styleable.Chip_android_textSize, textAppearance.textSize);
        setTextAppearance(textAppearance);
        int i5 = typedArrayObtainStyledAttributes.getInt(R.styleable.Chip_android_ellipsize, 0);
        if (i5 == 1) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            setChipIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, i6));
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            setCheckedIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, i7));
        }
        ...
        setMaxWidth(typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.Chip_android_maxWidth, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
