...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private int modifiers = FileManagerErrorCode.ENGINE_CANT_DECRYPT_FILE;
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM8clone = m8clone();
        excluderM8clone.serializeInnerClasses = false;
        return excluderM8clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM8clone = m8clone();
        excluderM8clone.requireExpose = true;
        return excluderM8clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM8clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM8clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM8clone = m8clone();
        excluderM8clone.modifiers = 0;
        for (int i2 : iArr) {
            excluderM8clone.modifiers = i2 | excluderM8clone.modifiers;
        }
        return excluderM8clone;
    }
