...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>>(LinkedTreeMap.this) { // from class: com.google.gson.internal.LinkedTreeMap.EntrySet.1
    ...
    public final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator<K>(LinkedTreeMap.this) { // from class: com.google.gson.internal.LinkedTreeMap.KeySet.1
                @Override // java.util.Iterator
                public K next() {
                    return nextNode().key;
                }
