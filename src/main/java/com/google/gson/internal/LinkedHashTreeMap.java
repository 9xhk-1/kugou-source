...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>>(LinkedHashTreeMap.this) { // from class: com.google.gson.internal.LinkedHashTreeMap.EntrySet.1
    ...
    public final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<K>(LinkedHashTreeMap.this) { // from class: com.google.gson.internal.LinkedHashTreeMap.KeySet.1
                @Override // java.util.Iterator
                public K next() {
                    return nextNode().key;
                }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public String toString() {
            return this.key + BaseConnection.HTTP_REQ_ENTITY_MERGE + this.value;
        }
