            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (zExcludeField || zExcludeField2) {
                    ...
                    while (i3 < fieldNames.size()) {
                        ...
                        boolean z = i3 != 0 ? false : zExcludeField;
                        int i4 = i3;
                        BoundField boundField2 = boundField;
                        List<String> list = fieldNames;
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(typeResolve), z, zExcludeField2)) : boundField2;
                        i3 = i4 + 1;
                        zExcludeField = z;
                        fieldNames = list;
                        field = field2;
