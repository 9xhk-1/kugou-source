    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i2) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long j2 = j;
                while ((i2 & (-128)) != 0) {
                    UnsafeUtil.putByte(this.buffer, j2, (byte) ((i2 & 127) | 128));
                    i2 >>>= 7;
                    j2 = 1 + j2;
                }
                UnsafeUtil.putByte(this.buffer, j2, (byte) i2);
                int i3 = (int) ((1 + j2) - j);
                this.position += i3;
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long j4 = j2;
                while ((j3 & (-128)) != 0) {
                    UnsafeUtil.putByte(this.buffer, j4, (byte) ((((int) j3) & 127) | 128));
                    j3 >>>= 7;
                    j4 = 1 + j4;
                }
                UnsafeUtil.putByte(this.buffer, j4, (byte) j3);
                int i2 = (int) ((1 + j4) - j2);
                this.position += i2;
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i2) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                long j = CodedOutputStream.ARRAY_BASE_OFFSET + ((long) this.position);
                while ((i2 & (-128)) != 0) {
                    UnsafeUtil.putByte(this.buffer, j, (byte) ((i2 & 127) | 128));
                    this.position++;
                    i2 >>>= 7;
                    j = 1 + j;
                }
                UnsafeUtil.putByte(this.buffer, j, (byte) i2);
                this.position++;
                return;
            }
            while ((i2 & (-128)) != 0) {
        ...
        public void write(byte[] bArr, int i2, int i3) throws IOException {
            if (bArr != null && i2 >= 0 && i3 >= 0 && bArr.length - i3 >= i2) {
                ...
                if (this.limit - j >= this.position) {
                    UnsafeUtil.copyMemory(bArr, UnsafeUtil.getArrayBaseOffset() + ((long) i2), null, this.position, j);
                    this.position += j;
                    return;
                }
            }
