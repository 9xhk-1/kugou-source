...
public final class Version {
    ...
    public static Version decodeVersionInformation(int i2) {
        ...
        while (true) {
            ...
            int iNumBitsDiffering = FormatInformation.numBitsDiffering(i2, i6);
            if (iNumBitsDiffering < i5) {
                i4 = i3 + 7;
                i5 = iNumBitsDiffering;
            }
            i3++;
        }
    }
