...
public class ReflectMethod {
    ...
    public synchronized <T> T invokeWithoutThrow(Object obj, Object... objArr) {
        try {
            try {
                ...
                TMachineLog.e(TAG, "invokeWithoutThrow, exception occur :%s", e2);
                return null;
            } catch (InvocationTargetException e3) {
                TMachineLog.e(TAG, "invokeWithoutThrow, exception occur :%s", e3);
                return null;
            }
        } catch (IllegalAccessException e4) {
            TMachineLog.e(TAG, "invokeWithoutThrow, exception occur :%s", e4);
            return null;
        } catch (NoSuchFieldException e5) {
            TMachineLog.e(TAG, "invokeWithoutThrow, exception occur :%s", e5);
            return null;
        }
    }
    ...
    public synchronized <T> T invoke(Object obj, boolean z, Object... objArr) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException, InvocationTargetException {
        ...
        if (z) {
            TMachineLog.w(TAG, "Field %s is no exists", this.mMethodName);
            return null;
        }
