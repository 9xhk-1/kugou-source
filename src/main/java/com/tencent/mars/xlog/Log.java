...
public class Log {
    ...
    public interface LogImp {
        ...
        void logD(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        void logE(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        void logF(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        void logI(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        void logV(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        void logW(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, String str4);

        long openLogInstance(int i2, int i3, String str, String str2, String str3, int i4);

        void releaseXlogInstance(String str);

        void setAppenderMode(long j, int i2);
    ...
    static {
        ...
        LogImp logImp2 = new LogImp() { // from class: com.tencent.mars.xlog.Log.1
            ...
            @Override // com.tencent.mars.xlog.Log.LogImp
            public void logF(long j, String str, String str2, String str3, int i2, int i3, long j2, long j3, final String str4) {
                if (Log.level > 5) {
                    return;
                }
                android.util.Log.e(str, str4);
            ...
            @Override // com.tencent.mars.xlog.Log.LogImp
            public void setAppenderMode(long j, int i2) {
            }
    ...
    public static void appenderOpen(int i2, int i3, String str, String str2, String str3, int i4) {
        LogImp logImp2 = logImp;
        if (logImp2 != null) {
            logImp2.appenderOpen(i2, i3, str, str2, str3, i4);
        }
    }
