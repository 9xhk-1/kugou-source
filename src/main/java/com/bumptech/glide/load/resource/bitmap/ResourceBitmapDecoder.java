...
public class ResourceBitmapDecoder implements ResourceDecoder<Uri, Bitmap> {
    ...
    public Resource<Bitmap> decode(@NonNull Uri uri, int i2, int i3, @NonNull Options options) {
        Resource<Drawable> resourceDecode = this.drawableDecoder.decode(uri, i2, i3, options);
        if (resourceDecode == null) {
            return null;
        }
        return DrawableToBitmapConverter.convert(this.bitmapPool, resourceDecode.get(), i2, i3);
    }
