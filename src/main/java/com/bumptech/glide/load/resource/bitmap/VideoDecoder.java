...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    @Nullable
    private static Bitmap decodeFrame(MediaMetadataRetriever mediaMetadataRetriever, long j, int i2, int i3, int i4, DownsampleStrategy downsampleStrategy) {
        Bitmap bitmapDecodeScaledFrame = (Build.VERSION.SDK_INT < 27 || i3 == Integer.MIN_VALUE || i4 == Integer.MIN_VALUE || downsampleStrategy == DownsampleStrategy.NONE) ? null : decodeScaledFrame(mediaMetadataRetriever, j, i2, i3, i4, downsampleStrategy);
    ...
    @Nullable
    @TargetApi(27)
    private static Bitmap decodeScaledFrame(MediaMetadataRetriever mediaMetadataRetriever, long j, int i2, int i3, int i4, DownsampleStrategy downsampleStrategy) {
        try {
            ...
            return mediaMetadataRetriever.getScaledFrameAtTime(j, i2, Math.round(i5 * scaleFactor), Math.round(scaleFactor * i6));
        } catch (Throwable th) {
