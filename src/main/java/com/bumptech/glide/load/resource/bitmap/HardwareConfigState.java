...
public final class HardwareConfigState {
    ...
    @TargetApi(26)
    public boolean setHardwareConfigIfAllowed(int i2, int i3, BitmapFactory.Options options, boolean z, boolean z2) {
        boolean zIsHardwareConfigAllowed = isHardwareConfigAllowed(i2, i3, z, z2);
