...
public interface IShareCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IShareCallback {
        ...
        public static class Proxy implements IShareCallback {
        ...
        public static IShareCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IShareCallback)) ? new Proxy(iBinder) : (IShareCallback) iInterfaceQueryLocalInterface;
        }
