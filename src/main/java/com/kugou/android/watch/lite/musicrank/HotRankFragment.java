...
@e.c.c.l.f.b(id = -1)
public final class HotRankFragment extends AbsRankListFragment {
    public int H;
    public final d I = f.b(new a());
    public final String J = "热歌榜";
    public final int K = 1;
    public final e.c.a.g.a.k.d.a L = new e.c.a.g.a.k.d.a(ApmDataTypeID.RANKING_LIST);
    ...
    public static final class a extends k implements f.z.c.a<g> {
        ...
        public final g invoke() {
            return new g(HotRankFragment.this, "1");
        }
    }

    public static final class b<T, R> implements Func1 {
        public final /* synthetic */ int a;
        public final /* synthetic */ HotRankFragment b;

        public b(int i2, HotRankFragment hotRankFragment) {
            this.a = i2;
        ...
        public final e.c.a.g.a.l.b call(Integer num) {
            e.c.a.g.a.k.b bVarC = e.c.a.g.a.k.b.c("热歌榜");
            int i2 = this.a;
            return bVarC.b("小天才", i2, e.c.a.g.a.k.c.c.a(i2), this.b.m());
        }
    }
    ...
    public static final class c<T, R> implements Func1 {
        ...
        public final e.c.a.g.a.f.k.c<e.c.a.g.a.l.b> call(e.c.a.g.a.l.b bVar) {
            ...
            if (bVar != null) {
                ...
                cVar.m(bVar.f());
                cVar.k(bVar.a());
                HotRankFragment.this.H += l0.e(bVar.e());
                cVar.h(HotRankFragment.this.H >= 100 || HotRankFragment.this.H >= bVar.d());
            } else {
                cVar.m(0);
                cVar.h(true);
            }
