...
@e.c.c.l.f.b(id = -1)
public final class FamilyRankFragment extends AbsRankListFragment {
    public int H;
    public final d I = f.b(new a());
    public final String J = "家长管控排行榜";
    public final int K = 1;
    public final e.c.a.g.a.k.d.a L = new e.c.a.g.a.k.d.a(ApmDataTypeID.RANK_FAMILY_LIST);
    ...
    public static final class a extends k implements f.z.c.a<g> {
        ...
        public final g invoke() {
            return new g(FamilyRankFragment.this, "5");
        }
    }

    public static final class b<T, R> implements Func1 {
        public final /* synthetic */ int a;
        public final /* synthetic */ FamilyRankFragment b;

        public b(int i2, FamilyRankFragment familyRankFragment) {
            this.a = i2;
        ...
        public final e.c.a.g.a.l.b call(Integer num) {
            e.c.a.g.a.k.a aVarC = e.c.a.g.a.k.a.c("家长管控");
            int i2 = this.a;
            return aVarC.b("小天才", i2, e.c.a.g.a.k.c.c.a(i2), this.b.m());
        }
    }
    ...
    public static final class c<T, R> implements Func1 {
        ...
        public final e.c.a.g.a.f.k.c<e.c.a.g.a.l.b> call(e.c.a.g.a.l.b bVar) {
            ...
            if (bVar != null) {
                ...
                cVar.k(bVar.a());
                cVar.l(bVar.b());
                FamilyRankFragment.this.H += l0.e(bVar.e());
                cVar.h(FamilyRankFragment.this.H >= 100 || FamilyRankFragment.this.H >= bVar.d());
            } else {
                cVar.m(0);
                cVar.h(true);
            }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        return View.inflate(getContext(), R.layout.fragment_family_list_rank, null);
    }
