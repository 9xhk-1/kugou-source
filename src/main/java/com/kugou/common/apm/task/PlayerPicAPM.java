...
public final class PlayerPicAPM {
    private String apmSession;

    private final YoungApmSessionModelImpl getMode() {
        return YoungApmSessionModelImpl.with(ApmDataTypeID.PLAYER_PIC_LOAD);
    }
    ...
    public final void start() {
        this.apmSession = getMode().start(ApmDataTypeID.PLAYER_PIC_LOAD);
    }
