...
public class KGUIPullToRefreshRecyclerView extends KGUIPullToRefreshBase<KGUIRecyclerBaseView> {
    public KGUIPullToRefreshRecyclerView(Context context) {
        super(context);
    }
    ...
    public KGUIPullToRefreshRecyclerView(Context context, Mode mode) {
        super(context, mode);
    }

    public KGUIPullToRefreshRecyclerView(Context context, Mode mode, AnimationStyle animationStyle) {
