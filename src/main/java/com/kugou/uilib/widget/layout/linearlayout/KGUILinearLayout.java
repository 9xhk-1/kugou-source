...
public class KGUILinearLayout extends KGUIBaseLinearLayout {
    public KGUILinearLayout(@NonNull Context context) {
        this(context, null, 0);
    }
    ...
    public KGUILinearLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    public KGUILinearLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
