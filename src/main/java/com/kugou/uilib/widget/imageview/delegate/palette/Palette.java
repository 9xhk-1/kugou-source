package com.kugou.uilib.widget.imageview.delegate.palette;
...
public final class Palette {
    ...
    public static final Filter DEFAULT_FILTER = new Filter() { // from class: com.kugou.uilib.widget.imageview.delegate.palette.Palette.1
        ...
        @Override // com.kugou.uilib.widget.imageview.delegate.palette.Palette.Filter
    ...
    private Swatch getMaxScoredSwatchForTarget(Target target) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (shouldBeScoredForTarget(swatch2, target)) {
                ...
                if (swatch == null || fGenerateScore > f2) {
                    swatch = swatch2;
                    f2 = fGenerateScore;
                }
            }
    ...
    public static final class Swatch {
        ...
        private void ensureTextColorsGenerated() {
            ...
            if (iCalculateMinimumAlpha3 == -1 || iCalculateMinimumAlpha3 == -1) {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            } else if (this.mResizeMaxDimension > 0 && (iMax = Math.max(bitmap.getWidth(), bitmap.getHeight())) > (i2 = this.mResizeMaxDimension)) {
                double d4 = i2;
                double d5 = iMax;
                Double.isNaN(d4);
                Double.isNaN(d5);
        ...
        public Palette generate() {
            ...
            if (bitmap != null) {
                ...
                if (bitmapScaleBitmapDown != this.mBitmap && rect != null) {
                    ...
                    Double.isNaN(d5);
                    rect.right = Math.min((int) Math.ceil(d5 * d2), bitmapScaleBitmapDown.getWidth());
                    double d6 = rect.bottom;
                    Double.isNaN(d6);
                    rect.bottom = Math.min((int) Math.ceil(d6 * d2), bitmapScaleBitmapDown.getHeight());
                }
        ...
        public AsyncTask<Bitmap, Void, Palette> generate(final PaletteAsyncListener paletteAsyncListener) {
            if (paletteAsyncListener != null) {
                return new AsyncTask<Bitmap, Void, Palette>() { // from class: com.kugou.uilib.widget.imageview.delegate.palette.Palette.Builder.1
