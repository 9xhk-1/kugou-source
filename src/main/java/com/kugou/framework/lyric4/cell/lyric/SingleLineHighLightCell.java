...
public class SingleLineHighLightCell extends SingleLineCell {
    ...
    public SingleLineHighLightCell(Context context, String[] strArr, AttachInfo attachInfo, int i2) {
    ...
    public void drawLyricLine(Canvas canvas, String str, float f2, float f3, float f4, Paint paint) {
        ...
        if (this.mHighLightPercentage <= 0.0f) {
            ...
            canvas.drawText(str, f2, f4, getPlayLinePaint(getDefaultPaint()));
            return;
        }
        RectF rectF = this.mTempRect;
        rectF.left = f2;
        rectF.right = this.mLyricLineInfo.getLineWidth() + f2;
