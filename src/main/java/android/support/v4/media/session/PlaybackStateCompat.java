...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i2) {
        ...
        @DoNotInline
        public static void setState(PlaybackState.Builder builder, int i2, long j, float f2, long j2) {
            builder.setState(i2, j, f2, j2);
        }
