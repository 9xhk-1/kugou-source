...
public final class d {
    ...
    public final void B(byte b) {
        switch (b) {
            ...
            case 13:
                ...
                throw new e.f.a.b.a.k.c.a("skipField with invalid type, type value: " + ((int) b) + ", " + ((int) aVar.a));
            default:
                throw new e.f.a.b.a.k.c.a("invalid type.");
        }
    }
    ...
    public boolean D(int i2) {
        ...
        try {
            ...
            return i2 == i3;
        } catch (e.f.a.b.a.k.c.a | BufferUnderflowException unused) {
            return false;
        }
    }
    ...
    public byte b(byte b, int i2, boolean z) {
        if (!D(i2)) {
            if (z) {
                throw new e.f.a.b.a.k.c.a("require field not exist.");
            }
            return b;
        }
        a aVar = new a();
        ...
        throw new e.f.a.b.a.k.c.a("type mismatch.");
    }
    ...
    public e g(e eVar, int i2, boolean z) {
        if (!D(i2)) {
            if (z) {
                throw new e.f.a.b.a.k.c.a("require field not exist.");
            }
        ...
        try {
            ...
            throw new e.f.a.b.a.k.c.a(e2.getMessage());
        }
    }
    ...
    public <T> Object h(T t, int i2, boolean z) {
        ...
        throw new e.f.a.b.a.k.c.a("read object error: unsupport type.");
    }
    ...
    public byte[] k(byte[] bArr, int i2, boolean z) {
        ...
        if (b == 9) {
            int iE = e(0, 0, true);
            if (iE < 0) {
                throw new e.f.a.b.a.k.c.a("size invalid: " + iE);
            }
        ...
        v(aVar2);
        if (aVar2.a != 0) {
            throw new e.f.a.b.a.k.c.a("type mismatch, tag: " + i2 + ", type: " + ((int) aVar.a) + ", " + ((int) aVar2.a));
        }
        int iE2 = e(0, 0, true);
        if (iE2 >= 0) {
        ...
        throw new e.f.a.b.a.k.c.a("invalid size, tag: " + i2 + ", type: " + ((int) aVar.a) + ", " + ((int) aVar2.a) + ", size: " + iE2);
    }
    ...
    public <T> T[] s(T[] tArr, int i2, boolean z) {
        if (tArr == null || tArr.length == 0) {
            throw new e.f.a.b.a.k.c.a("unable to get type of key and value.");
        }
    ...
    public String y(int i2, boolean z) {
        ...
        if (i4 > 104857600 || i4 < 0) {
            throw new e.f.a.b.a.k.c.a("String too long: " + i4);
        }
