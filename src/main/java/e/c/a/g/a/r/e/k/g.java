...
public final class g extends e.c.a.g.a.r.e.k.a {
    ...
    public static final class b extends k implements f.z.c.a<a> {
        ...
        public static final class a implements h.d {
            ...
            /* JADX INFO: renamed from: e.c.a.g.a.r.e.k.g$b$a$a, reason: collision with other inner class name */
            public static final class C0191a implements h.c {
                public final /* synthetic */ g a;
                public final /* synthetic */ UserData b;

                public C0191a(g gVar, UserData userData) {
                    this.a = gVar;
                    this.b = userData;
                }
            ...
            /* JADX INFO: renamed from: e.c.a.g.a.r.e.k.g$b$a$b, reason: collision with other inner class name */
            public static final class C0192b<T> implements Action1 {
                public final /* synthetic */ DelegateFragment a;
                public final /* synthetic */ g b;

                public C0192b(DelegateFragment delegateFragment, g gVar) {
            ...
            public void onLoginFailed(UserData userData, int i2) {
                ...
                e.c.a.g.a.r.e.k.e.a.a(userData, new C0191a(this.b, userData));
            }

            @Override // e.c.a.g.a.r.e.h.d
            public void onLoginRisk() {
                i1.a(this.b.J);
                this.b.J = Observable.just("").subscribeOn(AndroidSchedulers.mainThread()).subscribe(new C0192b(this.a, this.b), i1.b);
            ...
            public void onLoginSucceed(UserData userData, int i2) {
                ...
                this.a.e();
                e.c.a.g.a.e.b.b(new YoungBITask(12821194, "statistics").setSvar1("1"));
                this.b.s(1, userData, Integer.valueOf(i2));
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(DelegateFragment delegateFragment, g gVar) {
            super(0);
            this.a = delegateFragment;
            this.b = gVar;
        }
    ...
    public static final class c implements b.a {
        ...
        public void onFail(Throwable th) {
            g.this.l().i0();
            g.this.U(th);
            Log.e("mhs_watch", j.l("二维码展示 onFail: ", th));
        }

        @Override // e.c.a.g.a.r.e.k.b.a
        public void onStart() {
            g.this.l().q0(false);
            Log.e("mhs_watch", "二维码展示 showProgressDialog");
        }
        ...
        public void onSuccess(e.c.a.g.a.n.b.a aVar, e.c.a.g.a.n.b.d dVar) {
            ...
            g.this.l().i0();
            g.this.R(aVar, dVar);
            e.c.a.g.a.r.e.k.a.A(g.this, "二维码展示", null, 2, null);
        }
    }
    ...
    public static final class e<T, R> implements Func1 {
        ...
        public final Bitmap call(String str) {
            if (g0.a) {
                g0.b("WxQRCodeLoginStyle", j.l("onQrCodeRefresh: url=", str));
            }
            return a0.a(str);
        }
    }
    ...
    public static final class f<T> implements Action1 {
        public final /* synthetic */ e.c.a.g.a.n.b.d b;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public final /* synthetic */ String f1195d;

        public f(e.c.a.g.a.n.b.d dVar, String str) {
            this.b = dVar;
            this.f1195d = str;
        }
        ...
        public final void call(Bitmap bitmap) {
            if (bitmap == null || bitmap.isRecycled()) {
                if (g0.a) {
                    g0.b("WxQRCodeLoginStyle", "refreshQrcode: bitmap fail");
                }
                g.this.U(new Throwable("refreshQrcode: bitmap fail"));
            }
            g.this.I = true;
            g.this.H = this.b;
            ...
            e.c.a.g.a.r.e.k.a.A(g.this, j.l("微信 二维码 加载成功 wxCodeUrl = ", this.f1195d), null, 2, null);
        }
    }

    /* JADX INFO: renamed from: e.c.a.g.a.r.e.k.g$g, reason: collision with other inner class name */
    public static final class C0193g<T> implements Action1 {
        public final /* synthetic */ int b;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public final /* synthetic */ e.c.a.g.a.n.b.c f1196d;

        public C0193g(int i2, e.c.a.g.a.n.b.c cVar) {
            this.b = i2;
            this.f1196d = cVar;
        }
        ...
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public final void call(String str) {
            g.this.W(this.b, this.f1196d);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public g(DelegateFragment delegateFragment, View view, e.c.a.g.a.r.e.k.b bVar, ScrollView scrollView) {
        super(delegateFragment, view, R.layout.layout_login_wx_qr_code_style, bVar, scrollView);
        j.e(delegateFragment, "fragment");
        j.e(view, "view");
        ...
        this.K = -1;
        this.L = f.f.b(new b(delegateFragment, this));
    }
    ...
    public final void R(e.c.a.g.a.n.b.a aVar, e.c.a.g.a.n.b.d dVar) {
        if (g0.a) {
            g0.e("WxQRCodeLoginStyle", "refreshQrcode");
        }
        String strA = aVar.a();
        if (strA == null || strA.length() == 0) {
            U(new Throwable("refreshQrcode: wxCodeUrl isNullOrEmpty "));
            return;
        }
        String strP = p(dVar);
        if (!(strP == null || strP.length() == 0) && dVar.a == 2) {
            Observable.just(strP).subscribeOn(Schedulers.io()).map(e.a).observeOn(AndroidSchedulers.mainThread()).subscribe(new f(dVar, strP), i1.b);
            return;
        }
        StringBuilder sb = new StringBuilder();
        sb.append("refreshQrcode: wxCodeUrl");
        sb.append((Object) strP);
        sb.append(", wxCode.qrCodeType = ");
        sb.append(dVar == null ? null : Integer.valueOf(dVar.a));
        U(new Throwable(sb.toString()));
    }

    public final boolean S() {
        if (g0.a) {
            g0.e("WxQRCodeLoginStyle", "queryQRCodeStatus");
        }
        e.c.a.g.a.n.b.d dVar = this.H;
        String strA = dVar == null ? null : dVar.a();
        if (strA == null || strA.length() == 0) {
            return false;
        }
        e.c.a.g.a.n.b.c cVarE = e.c.a.g.a.n.b.b.e(strA);
        g(cVarE);
        if (cVarE != null && cVarE.b) {
            ...
            if (i2 == 1) {
                ...
                V(2, cVarE);
                if (g0.f()) {
                    Log.e("mhs_watch", "等待确认");
                }
            } else if (i2 == 4) {
                V(4, cVarE);
                l().q0(false);
                if (g0.a) {
                    g0.e("WxQRCodeLoginStyle", "loginStatus: nickName->" + ((Object) cVarE.f1119e) + " pic->" + ((Object) cVarE.f1120f) + " userId->" + cVarE.f1118d + " token->" + ((Object) cVarE.f1121g));
                }
                h hVar = new h();
                hVar.t(P());
                hVar.u(1);
    ...
    public final void V(int i2, e.c.a.g.a.n.b.c cVar) {
        Observable.just("").observeOn(AndroidSchedulers.mainThread()).subscribe(new C0193g(i2, cVar), i1.b);
    }

    @MainThread
    public final void W(int i2, e.c.a.g.a.n.b.c cVar) {
        if (g0.a) {
            g0.b("WxQRCodeLoginStyle", j.l("switchViewVisibility: codeStatus=", Integer.valueOf(i2)));
        }
        if (i2 == 0) {
            ...
            B(false);
            if (this.K != i2) {
                e.c.a.g.a.e.b.b(new YoungBITask(12821193, "statistics").setSvar1("1"));
            }
            if (g0.f()) {
                Log.e("mhs_watch", "1 请在手机上确认登录");
            }
        } else if (i2 == 4) {
            u1.e(this.u, this.x, this.D, this.v);
            u1.p(this.y);
            ...
            this.F.requestFocus();
            B(true);
            u0.A(23, "switchViewVisibilityMain-onNetError", "switchViewVisibilityMain-NER_ERR 网络异常");
        }
        this.K = i2;
        y(i2, cVar);
    }
    ...
    public void d(Object obj) {
        ...
        if (l() != null && (l() instanceof UserLoginIntegrationFragment)) {
            e.c.a.g.a.e.b.b(new YoungBITask(12821192, "exposure").setSvar1("1"));
        }
        l1.I(l().getActivity());
        e.c.a.g.a.r.e.k.b bVarN = n();
        ...
        String strA = dVarG.a();
        if ((strA == null || strA.length() == 0) || (aVar = this.G) == null) {
            return;
        }
        aVar.obtainMessage(0).sendToTarget();
    }
