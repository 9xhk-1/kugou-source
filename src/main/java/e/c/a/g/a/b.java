...
public final class b {
    ...
    public static final int AppCardWidgetProviderInfo_card_name = 0;
    public static final int AppCardWidgetProviderInfo_card_protocol = 1;
    public static final int AppCardWidgetProviderInfo_card_type = 2;
    public static final int AppCardWidgetProviderInfo_previewImage = 3;
    public static final int AppCardWidgetProviderInfo_preview_layout = 4;
    ...
    public static final int KGBaseImageView_android_scaleType = 0;
    public static final int KGBaseImageView_kgui_all_state_alpha = 1;
    public static final int KGBaseImageView_kgui_background_alpha = 2;
    public static final int KGBaseImageView_kgui_border_color = 3;
    public static final int KGBaseImageView_kgui_border_width = 4;
    public static final int KGBaseImageView_kgui_compound_drawable = 5;
    public static final int KGBaseImageView_kgui_compound_drawable_pivotX = 6;
    public static final int KGBaseImageView_kgui_compound_drawable_pivotX_self = 7;
    public static final int KGBaseImageView_kgui_compound_drawable_pivotY = 8;
    public static final int KGBaseImageView_kgui_compound_drawable_pivotY_self = 9;
    public static final int KGBaseImageView_kgui_corner_radius = 10;
    public static final int KGBaseImageView_kgui_corner_radius_bottom_left = 11;
    public static final int KGBaseImageView_kgui_corner_radius_bottom_right = 12;
    public static final int KGBaseImageView_kgui_corner_radius_top_left = 13;
    public static final int KGBaseImageView_kgui_corner_radius_top_right = 14;
    public static final int KGBaseImageView_kgui_default_bg_id = 15;
    public static final int KGBaseImageView_kgui_default_src_id = 16;
    public static final int KGBaseImageView_kgui_disable_alpha = 17;
    public static final int KGBaseImageView_kgui_enable_default_res = 18;
    public static final int KGBaseImageView_kgui_enable_mask = 19;
    public static final int KGBaseImageView_kgui_enable_state_color_filter = 20;
    public static final int KGBaseImageView_kgui_mask_color = 21;
    public static final int KGBaseImageView_kgui_mutate_background = 22;
    public static final int KGBaseImageView_kgui_normal_alpha = 23;
    public static final int KGBaseImageView_kgui_oval = 24;
    public static final int KGBaseImageView_kgui_press_alpha = 25;
    public static final int KGBaseImageView_kgui_press_color = 26;
    public static final int KGBaseImageView_kgui_press_scale_anim_ratio = 27;
    public static final int KGBaseImageView_kgui_ratio_wh = 28;
    public static final int KGBaseImageView_kgui_src_alpha = 29;
    public static final int KGBaseImageView_kgui_tile_mode = 30;
    public static final int KGBaseImageView_kgui_tile_mode_x = 31;
    public static final int KGBaseImageView_kgui_tile_mode_y = 32;
    public static final int KGBaseImageView_kui_skin_enable = 33;
    public static final int KGBaseImageView_skin_color_background = 34;
    public static final int KGBaseImageView_skin_color_background_alpha = 35;
    public static final int KGBaseImageView_skin_color_background_porterduff_mode = 36;
    public static final int KGBaseImageView_skin_color_src = 37;
    public static final int KGBaseImageView_skin_color_src_alpha = 38;
    public static final int KGBaseImageView_skin_color_src_porterduff_mode = 39;
    public static final int KGBaseImageView_skin_enable = 40;
    public static final int KGUIBaseConstraintLayout_kgui_all_state_alpha = 0;
    public static final int KGUIBaseConstraintLayout_kgui_background_alpha = 1;
    public static final int KGUIBaseConstraintLayout_kgui_border_color = 2;
    public static final int KGUIBaseConstraintLayout_kgui_border_width = 3;
    public static final int KGUIBaseConstraintLayout_kgui_corner_radius = 4;
    public static final int KGUIBaseConstraintLayout_kgui_corner_radius_bottom_left = 5;
    public static final int KGUIBaseConstraintLayout_kgui_corner_radius_bottom_right = 6;
    public static final int KGUIBaseConstraintLayout_kgui_corner_radius_top_left = 7;
    public static final int KGUIBaseConstraintLayout_kgui_corner_radius_top_right = 8;
    public static final int KGUIBaseConstraintLayout_kgui_disable_alpha = 9;
    public static final int KGUIBaseConstraintLayout_kgui_enable_mask = 10;
    public static final int KGUIBaseConstraintLayout_kgui_enable_state_color_filter = 11;
    public static final int KGUIBaseConstraintLayout_kgui_normal_alpha = 12;
    public static final int KGUIBaseConstraintLayout_kgui_press_alpha = 13;
    public static final int KGUIBaseConstraintLayout_kgui_press_chain_enable = 14;
    public static final int KGUIBaseConstraintLayout_kgui_press_scale_anim_ratio = 15;
    public static final int KGUIBaseConstraintLayout_kgui_ratio_wh = 16;
    public static final int KGUIBaseConstraintLayout_kgui_ripple_color = 17;
    public static final int KGUIBaseConstraintLayout_skin_enable = 18;
    public static final int KGUIBaseFrameLayout_kgui_all_state_alpha = 0;
    public static final int KGUIBaseFrameLayout_kgui_background_alpha = 1;
    public static final int KGUIBaseFrameLayout_kgui_border_color = 2;
    public static final int KGUIBaseFrameLayout_kgui_border_width = 3;
    public static final int KGUIBaseFrameLayout_kgui_compound_drawable = 4;
    public static final int KGUIBaseFrameLayout_kgui_compound_drawable_pivotX = 5;
    public static final int KGUIBaseFrameLayout_kgui_compound_drawable_pivotX_self = 6;
    public static final int KGUIBaseFrameLayout_kgui_compound_drawable_pivotY = 7;
    public static final int KGUIBaseFrameLayout_kgui_compound_drawable_pivotY_self = 8;
    public static final int KGUIBaseFrameLayout_kgui_corner_radius = 9;
    public static final int KGUIBaseFrameLayout_kgui_corner_radius_bottom_left = 10;
    public static final int KGUIBaseFrameLayout_kgui_corner_radius_bottom_right = 11;
    public static final int KGUIBaseFrameLayout_kgui_corner_radius_top_left = 12;
    public static final int KGUIBaseFrameLayout_kgui_corner_radius_top_right = 13;
    public static final int KGUIBaseFrameLayout_kgui_default_layout_id = 14;
    public static final int KGUIBaseFrameLayout_kgui_disable_alpha = 15;
    public static final int KGUIBaseFrameLayout_kgui_enable_mask = 16;
    public static final int KGUIBaseFrameLayout_kgui_enable_state_color_filter = 17;
    public static final int KGUIBaseFrameLayout_kgui_normal_alpha = 18;
    public static final int KGUIBaseFrameLayout_kgui_press_alpha = 19;
    public static final int KGUIBaseFrameLayout_kgui_press_chain_enable = 20;
    public static final int KGUIBaseFrameLayout_kgui_press_scale_anim_ratio = 21;
    public static final int KGUIBaseFrameLayout_kgui_ratio_wh = 22;
    public static final int KGUIBaseFrameLayout_kgui_ripple_color = 23;
    public static final int KGUIBaseFrameLayout_skin_enable = 24;
    public static final int KGUIBaseLinearLayout_kgui_all_state_alpha = 0;
    public static final int KGUIBaseLinearLayout_kgui_background_alpha = 1;
    public static final int KGUIBaseLinearLayout_kgui_border_color = 2;
    public static final int KGUIBaseLinearLayout_kgui_border_width = 3;
    public static final int KGUIBaseLinearLayout_kgui_compound_drawable = 4;
    public static final int KGUIBaseLinearLayout_kgui_compound_drawable_pivotX = 5;
    public static final int KGUIBaseLinearLayout_kgui_compound_drawable_pivotX_self = 6;
    public static final int KGUIBaseLinearLayout_kgui_compound_drawable_pivotY = 7;
    public static final int KGUIBaseLinearLayout_kgui_compound_drawable_pivotY_self = 8;
    public static final int KGUIBaseLinearLayout_kgui_corner_radius = 9;
    public static final int KGUIBaseLinearLayout_kgui_corner_radius_bottom_left = 10;
    public static final int KGUIBaseLinearLayout_kgui_corner_radius_bottom_right = 11;
    public static final int KGUIBaseLinearLayout_kgui_corner_radius_top_left = 12;
    public static final int KGUIBaseLinearLayout_kgui_corner_radius_top_right = 13;
    public static final int KGUIBaseLinearLayout_kgui_default_layout_id = 14;
    public static final int KGUIBaseLinearLayout_kgui_disable_alpha = 15;
    public static final int KGUIBaseLinearLayout_kgui_enable_mask = 16;
    public static final int KGUIBaseLinearLayout_kgui_enable_state_color_filter = 17;
    public static final int KGUIBaseLinearLayout_kgui_normal_alpha = 18;
    public static final int KGUIBaseLinearLayout_kgui_press_alpha = 19;
    public static final int KGUIBaseLinearLayout_kgui_press_chain_enable = 20;
    public static final int KGUIBaseLinearLayout_kgui_press_scale_anim_ratio = 21;
    public static final int KGUIBaseLinearLayout_kgui_ratio_wh = 22;
    public static final int KGUIBaseLinearLayout_kgui_ripple_color = 23;
    public static final int KGUIBaseLinearLayout_skin_enable = 24;
    public static final int KGUIBaseRelativeLayout_kgui_all_state_alpha = 0;
    public static final int KGUIBaseRelativeLayout_kgui_background_alpha = 1;
    public static final int KGUIBaseRelativeLayout_kgui_border_color = 2;
    public static final int KGUIBaseRelativeLayout_kgui_border_width = 3;
    public static final int KGUIBaseRelativeLayout_kgui_compound_drawable = 4;
    public static final int KGUIBaseRelativeLayout_kgui_compound_drawable_pivotX = 5;
    public static final int KGUIBaseRelativeLayout_kgui_compound_drawable_pivotX_self = 6;
    public static final int KGUIBaseRelativeLayout_kgui_compound_drawable_pivotY = 7;
    public static final int KGUIBaseRelativeLayout_kgui_compound_drawable_pivotY_self = 8;
    public static final int KGUIBaseRelativeLayout_kgui_corner_radius = 9;
    public static final int KGUIBaseRelativeLayout_kgui_corner_radius_bottom_left = 10;
    public static final int KGUIBaseRelativeLayout_kgui_corner_radius_bottom_right = 11;
    public static final int KGUIBaseRelativeLayout_kgui_corner_radius_top_left = 12;
    public static final int KGUIBaseRelativeLayout_kgui_corner_radius_top_right = 13;
    public static final int KGUIBaseRelativeLayout_kgui_default_layout_id = 14;
    public static final int KGUIBaseRelativeLayout_kgui_disable_alpha = 15;
    public static final int KGUIBaseRelativeLayout_kgui_enable_mask = 16;
    public static final int KGUIBaseRelativeLayout_kgui_enable_state_color_filter = 17;
    public static final int KGUIBaseRelativeLayout_kgui_normal_alpha = 18;
    public static final int KGUIBaseRelativeLayout_kgui_press_alpha = 19;
    public static final int KGUIBaseRelativeLayout_kgui_press_chain_enable = 20;
    public static final int KGUIBaseRelativeLayout_kgui_press_scale_anim_ratio = 21;
    public static final int KGUIBaseRelativeLayout_kgui_ratio_wh = 22;
    public static final int KGUIBaseRelativeLayout_kgui_ripple_color = 23;
    public static final int KGUIBaseRelativeLayout_skin_enable = 24;
    public static final int KGUIButton_kgui_all_state_alpha = 0;
    public static final int KGUIButton_kgui_background_alpha = 1;
    public static final int KGUIButton_kgui_border_color = 2;
    public static final int KGUIButton_kgui_border_width = 3;
    public static final int KGUIButton_kgui_compound_drawable = 4;
    public static final int KGUIButton_kgui_compound_drawable_pivotX = 5;
    public static final int KGUIButton_kgui_compound_drawable_pivotX_self = 6;
    public static final int KGUIButton_kgui_compound_drawable_pivotY = 7;
    public static final int KGUIButton_kgui_compound_drawable_pivotY_self = 8;
    public static final int KGUIButton_kgui_corner_radius = 9;
    public static final int KGUIButton_kgui_corner_radius_bottom_left = 10;
    public static final int KGUIButton_kgui_corner_radius_bottom_right = 11;
    public static final int KGUIButton_kgui_corner_radius_top_left = 12;
    public static final int KGUIButton_kgui_corner_radius_top_right = 13;
    public static final int KGUIButton_kgui_disable_alpha = 14;
    public static final int KGUIButton_kgui_enable_mask = 15;
    public static final int KGUIButton_kgui_enable_state_color_filter = 16;
    public static final int KGUIButton_kgui_normal_alpha = 17;
    public static final int KGUIButton_kgui_press_alpha = 18;
    public static final int KGUIButton_kgui_press_scale_anim_ratio = 19;
    public static final int KGUIButton_kgui_ratio_wh = 20;
    public static final int KGUIButton_skin_enable = 21;
    public static final int KGUICheckBox_kgui_cb_check_color = 0;
    public static final int KGUICheckBox_kgui_cb_check_press_color = 1;
    public static final int KGUICheckBox_kgui_cb_circle_style = 2;
    public static final int KGUICheckBox_kgui_cb_uncheck_color = 3;
    public static final int KGUICheckBox_skin_enable = 4;
    public static final int KGUICombineScrollLayout_kgui_head_collapsed_color = 0;
    public static final int KGUICombineScrollLayout_kgui_header_layout = 1;
    public static final int KGUICombineScrollLayout_kgui_scrollable_layout = 2;
    public static final int KGUICombineScrollLayout_kgui_top_space = 3;
    public static final int KGUIExpandableTextView_kgui_EllipsisHint = 0;
    public static final int KGUIExpandableTextView_kgui_EnableToggle = 1;
    public static final int KGUIExpandableTextView_kgui_GapToExpandHint = 2;
    public static final int KGUIExpandableTextView_kgui_GapToShrinkHint = 3;
    public static final int KGUIExpandableTextView_kgui_InitState = 4;
    public static final int KGUIExpandableTextView_kgui_MaxLinesOnShrink = 5;
    public static final int KGUIExpandableTextView_kgui_ToExpandHint = 6;
    public static final int KGUIExpandableTextView_kgui_ToExpandHintShow = 7;
    public static final int KGUIExpandableTextView_kgui_ToShrinkHint = 8;
    public static final int KGUIExpandableTextView_kgui_ToShrinkHintShow = 9;
    public static final int KGUIMarqueeTextView3_kgui_added_space = 0;
    public static final int KGUIMarqueeTextView3_kgui_default_text = 1;
    public static final int KGUIMarqueeTextView3_kgui_includeFontPadding = 2;
    public static final int KGUIMarqueeTextView3_kgui_max_font_scale = 3;
    public static final int KGUIMarqueeTextView3_kgui_skin_enable = 4;
    public static final int KGUIMarqueeTextView3_kgui_start_marquee_delay_time = 5;
    public static final int KGUIMarqueeTextView3_kgui_textcolor = 6;
    public static final int KGUIMarqueeTextView3_kgui_textcolor_str = 7;
    public static final int KGUIMarqueeTextView3_kgui_textsize = 8;
    public static final int KGUIPullToRefreshBase_kgui_ptrAdapterViewBackground = 0;
    public static final int KGUIPullToRefreshBase_kgui_ptrAnimationStyle = 1;
    public static final int KGUIPullToRefreshBase_kgui_ptrDrawable = 2;
    public static final int KGUIPullToRefreshBase_kgui_ptrDrawableBottom = 3;
    public static final int KGUIPullToRefreshBase_kgui_ptrDrawableEnd = 4;
    public static final int KGUIPullToRefreshBase_kgui_ptrDrawableStart = 5;
    public static final int KGUIPullToRefreshBase_kgui_ptrDrawableTop = 6;
    public static final int KGUIPullToRefreshBase_kgui_ptrHeadLoadingShowPositionCustom = 7;
    public static final int KGUIPullToRefreshBase_kgui_ptrHeaderBackground = 8;
    public static final int KGUIPullToRefreshBase_kgui_ptrHeaderSubTextColor = 9;
    public static final int KGUIPullToRefreshBase_kgui_ptrHeaderTextAppearance = 10;
    public static final int KGUIPullToRefreshBase_kgui_ptrHeaderTextColor = 11;
    public static final int KGUIPullToRefreshBase_kgui_ptrListViewExtrasEnabled = 12;
    public static final int KGUIPullToRefreshBase_kgui_ptrMode = 13;
    public static final int KGUIPullToRefreshBase_kgui_ptrOverScroll = 14;
    public static final int KGUIPullToRefreshBase_kgui_ptrRefreshableViewBackground = 15;
    public static final int KGUIPullToRefreshBase_kgui_ptrRotateDrawableWhilePulling = 16;
    public static final int KGUIPullToRefreshBase_kgui_ptrScrollingWhileRefreshingEnabled = 17;
    public static final int KGUIPullToRefreshBase_kgui_ptrShowIndicator = 18;
    public static final int KGUIPullToRefreshBase_kgui_ptrSubHeaderTextAppearance = 19;
    public static final int KGUIPullToRefreshBase_kgui_ptr_loadingLayout_factory = 20;
    public static final int KGUIPullToRefreshBase_kgui_ratio_wh = 21;
    public static final int KGUIPullToRefreshBase_kgui_scroll_character = 22;
    public static final int KGUIPullToRefreshBase_skin_enable = 23;
    public static final int KGUIRecyclerBaseView_kgui_direction_compact_enable = 0;
    public static final int KGUIRecyclerBaseView_kgui_hor_nest_scroll_enable = 1;
    public static final int KGUIRecyclerBaseView_kgui_ratio_wh = 2;
    public static final int KGUIRecyclerBaseView_kgui_scroll_character = 3;
    public static final int KGUIRecyclerBaseView_kgui_snap_helper_enable = 4;
    public static final int KGUIRecyclerBaseView_kgui_warp_content_enable = 5;
    public static final int KGUIRecyclerBaseView_skin_enable = 6;
    public static final int KGUISwipeTabView_kgui_auto_set_bg = 0;
    public static final int KGUISwipeTabView_kgui_bottom_line_visibility = 1;
    public static final int KGUISwipeTabView_kgui_drag_indicator = 2;
    public static final int KGUISwipeTabView_kgui_forbidden_set_bg = 3;
    public static final int KGUISwipeTabView_kgui_indicator_color = 4;
    public static final int KGUISwipeTabView_kgui_indicator_visible_by_user = 5;
    public static final int KGUISwipeTabView_kgui_is_msgcenter_style = 6;
    public static final int KGUISwipeTabView_kgui_main_layout = 7;
    public static final int KGUISwipeTabView_kgui_stv_default_item = 8;
    public static final int KGUISwitch_kgui_sw_thumb_check_color = 0;
    public static final int KGUISwitch_kgui_sw_thumb_uncheck_color = 1;
    public static final int KGUISwitch_kgui_sw_track_check_color = 2;
    public static final int KGUISwitch_kgui_sw_track_uncheck_color = 3;
    public static final int KGUISwitch_skin_enable = 4;
    public static final int KGUITextView_kgui_all_state_alpha = 0;
    public static final int KGUITextView_kgui_background_alpha = 1;
    public static final int KGUITextView_kgui_border_color = 2;
    public static final int KGUITextView_kgui_border_width = 3;
    public static final int KGUITextView_kgui_corner_radius = 4;
    public static final int KGUITextView_kgui_corner_radius_bottom_left = 5;
    public static final int KGUITextView_kgui_corner_radius_bottom_right = 6;
    public static final int KGUITextView_kgui_corner_radius_top_left = 7;
    public static final int KGUITextView_kgui_corner_radius_top_right = 8;
    public static final int KGUITextView_kgui_custom_font = 9;
    public static final int KGUITextView_kgui_disable_alpha = 10;
    public static final int KGUITextView_kgui_enable_mask = 11;
    public static final int KGUITextView_kgui_enable_state_color_filter = 12;
    public static final int KGUITextView_kgui_line_space_min_line_count = 13;
    public static final int KGUITextView_kgui_line_space_mult = 14;
    public static final int KGUITextView_kgui_mask_color = 15;
    public static final int KGUITextView_kgui_max_line_show_fold = 16;
    public static final int KGUITextView_kgui_normal_alpha = 17;
    public static final int KGUITextView_kgui_press_alpha = 18;
    public static final int KGUITextView_kgui_press_color = 19;
    public static final int KGUITextView_kgui_press_scale_anim_ratio = 20;
    public static final int KGUITextView_kgui_ratio_wh = 21;
    public static final int KGUITextView_kgui_span_at_enable = 22;
    public static final int KGUITextView_kgui_span_emoji_enable = 23;
    public static final int KGUITextView_kgui_span_link_enable = 24;
    public static final int KGUITextView_kgui_span_normal_bg_color = 25;
    public static final int KGUITextView_kgui_span_normal_text_color = 26;
    public static final int KGUITextView_kgui_span_pressed_bg_color = 27;
    public static final int KGUITextView_kgui_span_pressed_text_color = 28;
    public static final int KGUITextView_kgui_span_topic_enable = 29;
    public static final int KGUITextView_kgui_text_alpha = 30;
    public static final int KGUITextView_kgui_textview_bottomdrawable_height = 31;
    public static final int KGUITextView_kgui_textview_bottomdrawable_width = 32;
    public static final int KGUITextView_kgui_textview_is_vertical_mode = 33;
    public static final int KGUITextView_kgui_textview_last_line_no_bottom = 34;
    public static final int KGUITextView_kgui_textview_leftdrawable_center = 35;
    public static final int KGUITextView_kgui_textview_leftdrawable_height = 36;
    public static final int KGUITextView_kgui_textview_leftdrawable_width = 37;
    public static final int KGUITextView_kgui_textview_marquee_focused = 38;
    public static final int KGUITextView_kgui_textview_rightdrawable_height = 39;
    public static final int KGUITextView_kgui_textview_rightdrawable_width = 40;
    public static final int KGUITextView_kgui_textview_stroke_color = 41;
    public static final int KGUITextView_kgui_textview_stroke_width = 42;
    public static final int KGUITextView_kgui_textview_topdrawable_height = 43;
    public static final int KGUITextView_kgui_textview_topdrawable_width = 44;
    public static final int KGUITextView_kui_skin_enable = 45;
    public static final int KGUITextView_skin_color_background = 46;
    public static final int KGUITextView_skin_color_background_alpha = 47;
    public static final int KGUITextView_skin_color_background_porterduff_mode = 48;
    public static final int KGUITextView_skin_color_compound_src = 49;
    public static final int KGUITextView_skin_color_compound_src_alpha = 50;
    public static final int KGUITextView_skin_color_compound_src_porterduff_mode = 51;
    public static final int KGUITextView_skin_color_src = 52;
    public static final int KGUITextView_skin_color_src_alpha = 53;
    public static final int KGUITextView_skin_color_src_porterduff_mode = 54;
    public static final int KGUITextView_skin_enable = 55;
    public static final int KGUIViewGroup_kgui_default_layout_id = 0;
    public static final int KGUIViewGroup_kgui_press_chain_enable = 1;
    public static final int KGUIView_kgui_all_state_alpha = 0;
    public static final int KGUIView_kgui_background_alpha = 1;
    public static final int KGUIView_kgui_border_color = 2;
    public static final int KGUIView_kgui_border_width = 3;
    public static final int KGUIView_kgui_compound_drawable = 4;
    public static final int KGUIView_kgui_compound_drawable_pivotX = 5;
    public static final int KGUIView_kgui_compound_drawable_pivotX_self = 6;
    public static final int KGUIView_kgui_compound_drawable_pivotY = 7;
    public static final int KGUIView_kgui_compound_drawable_pivotY_self = 8;
    public static final int KGUIView_kgui_corner_radius = 9;
    public static final int KGUIView_kgui_corner_radius_bottom_left = 10;
    public static final int KGUIView_kgui_corner_radius_bottom_right = 11;
    public static final int KGUIView_kgui_corner_radius_top_left = 12;
    public static final int KGUIView_kgui_corner_radius_top_right = 13;
    public static final int KGUIView_kgui_disable_alpha = 14;
    public static final int KGUIView_kgui_enable_mask = 15;
    public static final int KGUIView_kgui_enable_rounded = 16;
    public static final int KGUIView_kgui_enable_state_color_filter = 17;
    public static final int KGUIView_kgui_mask_color = 18;
    public static final int KGUIView_kgui_normal_alpha = 19;
    public static final int KGUIView_kgui_press_alpha = 20;
    public static final int KGUIView_kgui_press_color = 21;
    public static final int KGUIView_kgui_press_scale_anim_ratio = 22;
    public static final int KGUIView_kgui_ratio_wh = 23;
    public static final int KGUIView_kgui_ripple_color = 24;
    public static final int KGUIView_kgui_skin_delegate = 25;
    public static final int KGUIView_kgui_view_bg_color = 26;
    public static final int KGUIView_kui_skin_enable = 27;
    public static final int KGUIView_skin_color_background = 28;
    public static final int KGUIView_skin_color_background_alpha = 29;
    public static final int KGUIView_skin_color_background_porterduff_mode = 30;
    public static final int KGUIView_skin_color_compound_src_alpha = 31;
    public static final int KGUIView_skin_color_compound_src_porterduff_mode = 32;
    public static final int KGUIView_skin_color_src = 33;
    public static final int KGUIView_skin_color_src_alpha = 34;
    public static final int KGUIView_skin_color_src_porterduff_mode = 35;
    public static final int KGUIView_skin_enable = 36;
    ...
    public static final int LoadingView_drawPadding = 0;
    public static final int LoadingView_iconBg = 1;
    public static final int LoadingView_iconLoading = 2;
    public static final int LoadingView_iconLogo = 3;
    public static final int LoadingView_iconPrimaryColor = 4;
    public static final int LoadingView_iconSecondaryColor = 5;
    public static final int LoadingView_loadingPosition = 6;
    public static final int LoadingView_loadingPrimaryText = 7;
    public static final int LoadingView_loadingSecondaryText = 8;
    public static final int LoadingView_loadingTextColor = 9;
    public static final int LoadingView_loadingTextMode = 10;
    public static final int LoadingView_loadingTextSize = 11;
    ...
    public static final int RoundedImageView_riv_press_effect = 10;
    ...
    public static final int SwipeBackLayout_kg_edge_flag = 0;
    public static final int SwipeBackLayout_kg_edge_size = 1;
    public static final int SwipeTabView_auto_set_bg = 0;
    public static final int SwipeTabView_bottom_line_visibility = 1;
    public static final int SwipeTabView_drag_indicator = 2;
    public static final int SwipeTabView_forbidden_set_bg = 3;
    public static final int SwipeTabView_indicator_color = 4;
    public static final int SwipeTabView_indicator_visible_by_user = 5;
    public static final int SwipeTabView_is_msgcenter_style = 6;
    public static final int SwipeTabView_stv_default_item = 7;
    ...
    public static final int YoungRoundedImageView_young_be_square = 0;
    public static final int YoungRoundedImageView_young_bg_color = 1;
    public static final int YoungRoundedImageView_young_bg_press_effect_enable = 2;
    public static final int YoungRoundedImageView_young_default_bg = 3;
    public static final int bubble_bubble_backgroundColor = 0;
    public static final int bubble_bubble_cornerRadius = 1;
    public static final int bubble_bubble_halfBaseOfLeg = 2;
    public static final int bubble_bubble_padding = 3;
    public static final int bubble_bubble_shadowColor = 4;
    public static final int bubble_bubble_strokeWidth = 5;
    ...
    public static final int[] AppCardWidgetProviderInfo = {R.attr.card_name, R.attr.card_protocol, R.attr.card_type, R.attr.previewImage, R.attr.preview_layout};
    ...
    public static final int[] KGBaseImageView = {android.R.attr.scaleType, R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_default_bg_id, R.attr.kgui_default_src_id, R.attr.kgui_disable_alpha, R.attr.kgui_enable_default_res, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_mask_color, R.attr.kgui_mutate_background, R.attr.kgui_normal_alpha, R.attr.kgui_oval, R.attr.kgui_press_alpha, R.attr.kgui_press_color, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_src_alpha, R.attr.kgui_tile_mode, R.attr.kgui_tile_mode_x, R.attr.kgui_tile_mode_y, R.attr.kui_skin_enable, R.attr.skin_color_background, R.attr.skin_color_background_alpha, R.attr.skin_color_background_porterduff_mode, R.attr.skin_color_src, R.attr.skin_color_src_alpha, R.attr.skin_color_src_porterduff_mode, R.attr.skin_enable};
    public static final int[] KGUIBaseConstraintLayout = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_chain_enable, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_ripple_color, R.attr.skin_enable};
    public static final int[] KGUIBaseFrameLayout = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_default_layout_id, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_chain_enable, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_ripple_color, R.attr.skin_enable};
    public static final int[] KGUIBaseLinearLayout = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_default_layout_id, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_chain_enable, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_ripple_color, R.attr.skin_enable};
    public static final int[] KGUIBaseRelativeLayout = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_default_layout_id, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_chain_enable, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_ripple_color, R.attr.skin_enable};
    public static final int[] KGUIButton = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.skin_enable};
    public static final int[] KGUICheckBox = {R.attr.kgui_cb_check_color, R.attr.kgui_cb_check_press_color, R.attr.kgui_cb_circle_style, R.attr.kgui_cb_uncheck_color, R.attr.skin_enable};
    public static final int[] KGUICombineScrollLayout = {R.attr.kgui_head_collapsed_color, R.attr.kgui_header_layout, R.attr.kgui_scrollable_layout, R.attr.kgui_top_space};
    public static final int[] KGUIExpandableTextView = {R.attr.kgui_EllipsisHint, R.attr.kgui_EnableToggle, R.attr.kgui_GapToExpandHint, R.attr.kgui_GapToShrinkHint, R.attr.kgui_InitState, R.attr.kgui_MaxLinesOnShrink, R.attr.kgui_ToExpandHint, R.attr.kgui_ToExpandHintShow, R.attr.kgui_ToShrinkHint, R.attr.kgui_ToShrinkHintShow};
    public static final int[] KGUIMarqueeTextView3 = {R.attr.kgui_added_space, R.attr.kgui_default_text, R.attr.kgui_includeFontPadding, R.attr.kgui_max_font_scale, R.attr.kgui_skin_enable, R.attr.kgui_start_marquee_delay_time, R.attr.kgui_textcolor, R.attr.kgui_textcolor_str, R.attr.kgui_textsize};
    public static final int[] KGUIPullToRefreshBase = {R.attr.kgui_ptrAdapterViewBackground, R.attr.kgui_ptrAnimationStyle, R.attr.kgui_ptrDrawable, R.attr.kgui_ptrDrawableBottom, R.attr.kgui_ptrDrawableEnd, R.attr.kgui_ptrDrawableStart, R.attr.kgui_ptrDrawableTop, R.attr.kgui_ptrHeadLoadingShowPositionCustom, R.attr.kgui_ptrHeaderBackground, R.attr.kgui_ptrHeaderSubTextColor, R.attr.kgui_ptrHeaderTextAppearance, R.attr.kgui_ptrHeaderTextColor, R.attr.kgui_ptrListViewExtrasEnabled, R.attr.kgui_ptrMode, R.attr.kgui_ptrOverScroll, R.attr.kgui_ptrRefreshableViewBackground, R.attr.kgui_ptrRotateDrawableWhilePulling, R.attr.kgui_ptrScrollingWhileRefreshingEnabled, R.attr.kgui_ptrShowIndicator, R.attr.kgui_ptrSubHeaderTextAppearance, R.attr.kgui_ptr_loadingLayout_factory, R.attr.kgui_ratio_wh, R.attr.kgui_scroll_character, R.attr.skin_enable};
    public static final int[] KGUIRecyclerBaseView = {R.attr.kgui_direction_compact_enable, R.attr.kgui_hor_nest_scroll_enable, R.attr.kgui_ratio_wh, R.attr.kgui_scroll_character, R.attr.kgui_snap_helper_enable, R.attr.kgui_warp_content_enable, R.attr.skin_enable};
    public static final int[] KGUISwipeTabView = {R.attr.kgui_auto_set_bg, R.attr.kgui_bottom_line_visibility, R.attr.kgui_drag_indicator, R.attr.kgui_forbidden_set_bg, R.attr.kgui_indicator_color, R.attr.kgui_indicator_visible_by_user, R.attr.kgui_is_msgcenter_style, R.attr.kgui_main_layout, R.attr.kgui_stv_default_item};
    public static final int[] KGUISwitch = {R.attr.kgui_sw_thumb_check_color, R.attr.kgui_sw_thumb_uncheck_color, R.attr.kgui_sw_track_check_color, R.attr.kgui_sw_track_uncheck_color, R.attr.skin_enable};
    public static final int[] KGUITextView = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_custom_font, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_state_color_filter, R.attr.kgui_line_space_min_line_count, R.attr.kgui_line_space_mult, R.attr.kgui_mask_color, R.attr.kgui_max_line_show_fold, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_color, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_span_at_enable, R.attr.kgui_span_emoji_enable, R.attr.kgui_span_link_enable, R.attr.kgui_span_normal_bg_color, R.attr.kgui_span_normal_text_color, R.attr.kgui_span_pressed_bg_color, R.attr.kgui_span_pressed_text_color, R.attr.kgui_span_topic_enable, R.attr.kgui_text_alpha, R.attr.kgui_textview_bottomdrawable_height, R.attr.kgui_textview_bottomdrawable_width, R.attr.kgui_textview_is_vertical_mode, R.attr.kgui_textview_last_line_no_bottom, R.attr.kgui_textview_leftdrawable_center, R.attr.kgui_textview_leftdrawable_height, R.attr.kgui_textview_leftdrawable_width, R.attr.kgui_textview_marquee_focused, R.attr.kgui_textview_rightdrawable_height, R.attr.kgui_textview_rightdrawable_width, R.attr.kgui_textview_stroke_color, R.attr.kgui_textview_stroke_width, R.attr.kgui_textview_topdrawable_height, R.attr.kgui_textview_topdrawable_width, R.attr.kui_skin_enable, R.attr.skin_color_background, R.attr.skin_color_background_alpha, R.attr.skin_color_background_porterduff_mode, R.attr.skin_color_compound_src, R.attr.skin_color_compound_src_alpha, R.attr.skin_color_compound_src_porterduff_mode, R.attr.skin_color_src, R.attr.skin_color_src_alpha, R.attr.skin_color_src_porterduff_mode, R.attr.skin_enable};
    public static final int[] KGUIView = {R.attr.kgui_all_state_alpha, R.attr.kgui_background_alpha, R.attr.kgui_border_color, R.attr.kgui_border_width, R.attr.kgui_compound_drawable, R.attr.kgui_compound_drawable_pivotX, R.attr.kgui_compound_drawable_pivotX_self, R.attr.kgui_compound_drawable_pivotY, R.attr.kgui_compound_drawable_pivotY_self, R.attr.kgui_corner_radius, R.attr.kgui_corner_radius_bottom_left, R.attr.kgui_corner_radius_bottom_right, R.attr.kgui_corner_radius_top_left, R.attr.kgui_corner_radius_top_right, R.attr.kgui_disable_alpha, R.attr.kgui_enable_mask, R.attr.kgui_enable_rounded, R.attr.kgui_enable_state_color_filter, R.attr.kgui_mask_color, R.attr.kgui_normal_alpha, R.attr.kgui_press_alpha, R.attr.kgui_press_color, R.attr.kgui_press_scale_anim_ratio, R.attr.kgui_ratio_wh, R.attr.kgui_ripple_color, R.attr.kgui_skin_delegate, R.attr.kgui_view_bg_color, R.attr.kui_skin_enable, R.attr.skin_color_background, R.attr.skin_color_background_alpha, R.attr.skin_color_background_porterduff_mode, R.attr.skin_color_compound_src_alpha, R.attr.skin_color_compound_src_porterduff_mode, R.attr.skin_color_src, R.attr.skin_color_src_alpha, R.attr.skin_color_src_porterduff_mode, R.attr.skin_enable};
    public static final int[] KGUIViewGroup = {R.attr.kgui_default_layout_id, R.attr.kgui_press_chain_enable};
    ...
    public static final int[] LoadingView = {R.attr.drawPadding, R.attr.iconBg, R.attr.iconLoading, R.attr.iconLogo, R.attr.iconPrimaryColor, R.attr.iconSecondaryColor, R.attr.loadingPosition, R.attr.loadingPrimaryText, R.attr.loadingSecondaryText, R.attr.loadingTextColor, R.attr.loadingTextMode, R.attr.loadingTextSize};
    ...
    public static final int[] SwipeBackLayout = {R.attr.kg_edge_flag, R.attr.kg_edge_size};
    public static final int[] SwipeTabView = {R.attr.auto_set_bg, R.attr.bottom_line_visibility, R.attr.drag_indicator, R.attr.forbidden_set_bg, R.attr.indicator_color, R.attr.indicator_visible_by_user, R.attr.is_msgcenter_style, R.attr.stv_default_item};
    ...
    public static final int[] YoungRoundedImageView = {R.attr.young_be_square, R.attr.young_bg_color, R.attr.young_bg_press_effect_enable, R.attr.young_default_bg};
    public static final int[] bubble = {R.attr.bubble_backgroundColor, R.attr.bubble_cornerRadius, R.attr.bubble_halfBaseOfLeg, R.attr.bubble_padding, R.attr.bubble_shadowColor, R.attr.bubble_strokeWidth};
}
